...
public class PermissionUtils {
    ...
    public interface PermissionAskListener extends PermissionListener {
    ...
    // check permissions
    public static void checkPermissions(Context context, String[] permissions, PermissionListener listener) {
